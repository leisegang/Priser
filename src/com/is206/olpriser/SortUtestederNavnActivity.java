 ...
 */
public class SortUtestederNavnActivity extends ListActivity {
	...
	private static String url_all_utesteder = "http://priser.leisegang.no/get_all_utested_sort_name.php";
    ...
    {    
        ...
        case R.id.hjem:
        	...
        	Intent utestederIntent = new Intent(getApplicationContext(), SortUtestederNavnActivity.class);
			startActivityForResult(utestederIntent, 0);
            Toast.makeText(SortUtestederNavnActivity.this, "Hjem", Toast.LENGTH_SHORT).show();
            return true;
 
        case R.id.tipsOss:
        	Intent tipsIntent = new Intent(getApplicationContext(), TipsUsActivity.class);
			startActivityForResult(tipsIntent, 0);
            Toast.makeText(SortUtestederNavnActivity.this, "Tips oss!", Toast.LENGTH_SHORT).show();
            return true;
 
        case R.id.omOss:
        	Intent hjemIntent = new Intent(getApplicationContext(), AboutUsActivity.class);
			startActivityForResult(hjemIntent, 0);
            Toast.makeText(SortUtestederNavnActivity.this, "Om oss", Toast.LENGTH_SHORT).show();
            return true;
            
        case R.id.sortNavn:
        	Intent navnIntent = new Intent(getApplicationContext(), SortUtestederNavnActivity.class);
			startActivityForResult(navnIntent, 0);
            Toast.makeText(SortUtestederNavnActivity.this, "Sortert etter navn", Toast.LENGTH_SHORT).show();
            return true;
            
        case R.id.sortPris:
        	Intent prisIntent = new Intent(getApplicationContext(), SortUtestederPrisActivity.class);
			startActivityForResult(prisIntent, 0);
            Toast.makeText(SortUtestederNavnActivity.this, "Sortert etter pris", Toast.LENGTH_SHORT).show();
            return true;
        ...
        case R.id.sortRating:
            ...
            Toast.makeText(SortUtestederNavnActivity.this, "Sortert etter rating", Toast.LENGTH_SHORT).show();
            return true;            
	...
	class LoadAllUtesteder extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(SortUtestederNavnActivity.this);
			...
			runOnUiThread(new Runnable() {
				public void run() {
					...
					ListAdapter adapter = new SimpleAdapter(
							SortUtestederNavnActivity.this, utestederList,
